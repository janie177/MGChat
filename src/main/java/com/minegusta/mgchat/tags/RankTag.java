...
public enum RankTag
{
    ADMIN(ChatColor.DARK_RED + "[A]", 6),
    MODERATOR(ChatColor.DARK_AQUA + "[M]", 6),
    MODERATORPLUS(ChatColor.DARK_AQUA + "[M" + ChatColor.GOLD + "+" + ChatColor.DARK_AQUA + "]", 6),
    TRUSTED(ChatColor.BLUE + "[T]", 6),
    OWNER(ChatColor.YELLOW + "[O]", 6),
    OVERSEER(ChatColor.GRAY + "«" + ChatColor.GOLD + "" + ChatColor.MAGIC + "|||" + ChatColor.RESET + ChatColor.GRAY + "»", 6),
    BUILDERPLUS(ChatColor.DARK_GREEN + "[B+]", 6),
    BUILDER(ChatColor.GREEN + "[B]", 6),
    HEADADMIN(ChatColor.RED + "[H]", 5),
